	...
	render() {
		return React.createElement('div', {id:"base-stats-pane", className:"pane"},
			React.createElement('div', {id:"stats-part", className:"col-12-grid"},
				React.createElement('div', {className:"span-col-twelve-grid-half"}, React.createElement(DoublePositiveIntegerCharacterDataInput, {characterDataPath0: ["stats", "wounds", "threshold"], characterDataPathBase0: ["stats", "wounds", "base"], characterDataPath1: ["stats", "wounds", "current"], id:"stats-wounds", name:"Wounds", name0:"Threshold", name1:"Current"})),
				React.createElement('div', {className:"span-col-twelve-grid-half"}, React.createElement(DoublePositiveIntegerCharacterDataInput, {characterDataPath0: ["stats", "strain", "threshold"], characterDataPathBase0: ["stats", "strain", "base"], characterDataPath1: ["stats", "strain", "current"], id:"stats-strain", name:"Strain", name0:"Threshold", name1:"Current"})),
				...
				React.createElement('div', {className:"span-col-twelve-grid-half"}, React.createElement(DoublePositiveIntegerCharacterDataInput, {characterDataPath0: ["stats", "forcePool", "committed"], characterDataPathBase0:["stats", "forcePool", "base"], characterDataPath1: ["stats", "forcePool", "available"], id:"stats-force-pool", name:"Force Pool", name0:"Committed", name1:"Available"})),
